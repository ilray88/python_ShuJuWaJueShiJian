...
#ax.set_title("不同居住时间各产品类型购买情况")
ax.set_xlabel('当前城市居住年数')
ax.set_ylabel('金额')
...
bf_gen_mar_sum.index=['f_0','f_1','m_0','m_1']
plt.xticks(bf_gen_mar_sum.index, bf_gen_mar_sum.index, rotation=30)
bf_gen_mar_sum.columns=['产品类别1','产品类别2','产品类别3']

print(bf_gen_mar_sum)
bf_gen_mar_sum.plot(kind='bar',title="不同性别和婚姻状况对购买产品类别情况")
plt.show()
