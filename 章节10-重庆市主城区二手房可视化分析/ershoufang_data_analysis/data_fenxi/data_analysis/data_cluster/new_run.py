...
def loadDataset():
    ...
    # 合并经纬度数据
    df_latlng = pd.read_csv("../data_file/latlng_utf_8.csv", skiprows=[0], names=["did", "communityName", "id", "lat", "lng"])
    del df_latlng["did"]
...
for i in result_mean:
    print(" " + str(gr) + "         " + str(i[1]) + " 		" + str(i[2]) + "   	" + str(i[3]) + "\t\t" + str(
        len(data_df[gr])))
    gr = gr + 1
...
data_df[0].plot(x="jzmj", y="unitprice", kind="scatter", label="0", color=colors[0], fontsize=12, ax=ax, alpha=0.4,
                xticks=[0, 50, 100, 150, 200, 250, 300, 400, 500], xlim=[0, 600])
data_df[1].plot(x="jzmj", y="unitprice", kind="scatter", label="1", color=colors[1], fontsize=12, ax=ax, alpha=0.4,
                xticks=[0, 50, 100, 150, 200, 250, 300, 400, 500], xlim=[0, 600])
data_df[2].plot(x="jzmj", y="unitprice", kind="scatter", label="2", color=colors[2], fontsize=12, ax=ax, alpha=0.4,
                xticks=[0, 50, 100, 150, 200, 250, 300, 400, 500], xlim=[0, 600])
data_df[3].plot(x="jzmj", y="unitprice", kind="scatter", label="3", color=colors[3], fontsize=12, ax=ax, alpha=0.4,
                xticks=[0, 50, 100, 150, 200, 250, 300, 400, 500], xlim=[0, 600])
data_df[4].plot(x="jzmj", y="unitprice", kind="scatter", label="4", color=colors[4], fontsize=12, ax=ax, alpha=0.4,
                xticks=[0, 50, 100, 150, 200, 250, 300, 400, 500], xlim=[0, 600])
...
data_df[0].plot(x="jzmj", y="total", kind="scatter", label="0", color=colors[0], fontsize=12, ax=ax, alpha=0.4,
                xticks=[0, 50, 100, 150, 200, 250, 300, 400, 500], xlim=[0, 600])
data_df[1].plot(x="jzmj", y="total", kind="scatter", label="1", color=colors[1], fontsize=12, ax=ax, alpha=0.4,
                xticks=[0, 50, 100, 150, 200, 250, 300, 400, 500], xlim=[0, 600])
data_df[2].plot(x="jzmj", y="total", kind="scatter", label="2", color=colors[2], fontsize=12, ax=ax, alpha=0.4,
                xticks=[0, 50, 100, 150, 200, 250, 300, 400, 500], xlim=[0, 600])
data_df[3].plot(x="jzmj", y="total", kind="scatter", label="3", color=colors[3], fontsize=12, ax=ax, alpha=0.4,
                xticks=[0, 50, 100, 150, 200, 250, 300, 400, 500], xlim=[0, 600])
data_df[4].plot(x="jzmj", y="total", kind="scatter", label="4", color=colors[4], fontsize=12, ax=ax, alpha=0.4,
                xticks=[0, 50, 100, 150, 200, 250, 300, 400, 500], xlim=[0, 600])
ax.set_xlabel("建筑面积(㎡)", fontsize=14)
