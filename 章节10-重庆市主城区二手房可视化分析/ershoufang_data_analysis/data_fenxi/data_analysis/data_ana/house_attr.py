...
filename = "../data_file/../data_file/new_new_utf_8.csv"
...
ax.set_title("重庆主城区二手房房屋户型占比情况",fontsize=18)
...
fig = plt.figure(figsize=(9,9))
ax = fig.add_subplot(111)
ax.set_title("重庆主城区二手房装修占比情况",fontsize=18)
...
fig = plt.figure(figsize=(9,9))
ax = fig.add_subplot(111)
ax.set_title("重庆主城区二手房建筑类型占比情况",fontsize=18)
...
ax.set_title("重庆主城区二手房建筑面积分布区间",fontsize=18)
plt.show()
