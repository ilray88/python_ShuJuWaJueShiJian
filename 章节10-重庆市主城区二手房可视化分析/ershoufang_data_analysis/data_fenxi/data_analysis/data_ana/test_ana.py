...
ax.set_ylabel("单价 (元/平方米)")
#ax.set_title("重庆主城区各区域二手房平均单价")
...
ax = fig.add_subplot(111)
ax.set_ylabel("建筑面积(㎡)")
ax.set_title("重庆主城区各区域二手房平均建筑面积")
...
ax1.set_ylabel("单价 (元/方平米)")
ax1.set_title("重庆主城区各区域二手房平均单价")
ax2 = fig.add_subplot(2,1,2)
ax2.set_ylabel("建筑面积(㎡)")
ax2.set_title("重庆主城区各区域二手房平均建筑面积")
...
fig = plt.figure(figsize=(12,7))
ax = fig.add_subplot(111)
ax.set_ylabel("单价(元/方平米)")
ax.set_title("重庆主城区二手房单价最高Top10")
